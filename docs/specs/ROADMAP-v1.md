...
**Status:** M1 complete — baseline locked at [baseline-1.md](release-quality-baseline/baseline-1.md). Thresholds: faithfulness ≥ 0.9686 (mean 0.979, σ 0.0052), P@1 ≥ 0.95, R@3 ≥ 1.00. M2 (threshold-check script + CI wiring) next.
