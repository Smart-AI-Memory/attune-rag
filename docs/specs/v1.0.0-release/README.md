...
- [ ] **Phase 4 closed.** `docs/specs/downstream-validation/exit-summary.md`
      (W4.3) exists and recommends the 0.2.0 cut.
- [ ] **0.2.0 published.** PyPI shows `attune-rag==0.2.0`; the
      classifier flip is *not* part of 0.2.0 (it's this spec's job).
...
- [docs/specs/api-v0.2-public-surface/](../api-v0.2-public-surface/)
  — what 1.0.0 ratifies as the stable surface.
...
- [docs/specs/phase-5-backlog/](../phase-5-backlog/) — deferred-
  ...
  (see [items.md](../phase-5-backlog/items.md)).
