...
Ranking guidance:
- Document paths containing "tool-" (e.g. concepts/tool-release-prep.md) are canonical
  attune workflow references. Paths containing "task-" (e.g. concepts/task-package-publishing.md)
  are incidental how-to guides. For workflow-goal queries, rank tool-* docs above task-* docs.
- "Publish", "release", or "ship" a package → prefer tool-release-prep.md because attune's
  release workflow runs health, security, and changelog checks before the publish step.
